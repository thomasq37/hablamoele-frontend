...
const freemaninit = (function() {
    ...
    let continuousElements = document.getElementsByClassName("sectionblock");
    let counter = document.querySelectorAll(".counterwrap__counter");
    let counters = document.querySelectorAll(".counterwrap__counter");
    let mobilelink = document.querySelectorAll('.overlay__listnav li a');
    let mobilenav = document.querySelector('.navicon');
    ...
    let sliderService = document.getElementById("sliderservice");
    let yearele = document.querySelector('.years');
    let btnContainer = document.getElementById("filterwrap");
    let btns = btnContainer.getElementsByTagName("li");
    let porto = document.getElementById('porfoliowarp');
    ...
    let charIndex = 0;
    let textArray = ["Profesora de español", "Iniciación", "Cursos avanzados"];
    let year = new Date().getFullYear();
    let revealPoint = 150;
    let interval = 0;
    let loop = 0;
    //let burger = document.querySelector('.mobilenav');
    ...
    const portofolio = function(e) {
        let myShuffle = new Shuffle(porto, {
    ...
    const scrolspy = function(e) {
        const headerOffset = 7 * parseFloat(getComputedStyle(document.documentElement).fontSize); // 7rem en pixels
        ...
        window.onscroll = (() => {
            mainSection.forEach((v, i) => {
                ...
                if (rect < window.innerHeight - headerOffset - 100) {
    ...
    const servicesslider = function(e) {
        ...
        let slider = new KeenSlider(sliderService, {
            loop: true,
            mode: "free-snap",
            breakpoints: {
                "(min-width: 320px)": {
